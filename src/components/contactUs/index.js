...
function contactUs() {
  ...
  return (
    ...
    <div className='ContactUs main'>
      ...
      >
        {/* <div
          className="relative left-1/2 -z-10 aspect-[1155/678] w-[36.125rem] max-w-none -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-[#2196F3] to-[#2196F3] opacity-30 sm:left-[calc(50%-40rem)] sm:w-[72.1875rem]"
          style={{
            clipPath:
