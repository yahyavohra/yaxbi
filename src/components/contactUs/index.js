...
function contactUs() {
  return (
    ...
    <div className='ContactUs main'>
        <div className="isolate bg-white md:px-6 px-4 md:py-24  xs:py-2 sm:py-32 lg:px-8">
  ...
  frameBorder={0}
  style={{ minWidth: "100%", maxWidth: "100%", height: '880px', border: "none" }}
  scrolling="no"
/>
        </div>
        <div className='bigImage hidden md:block'>
        <Image
