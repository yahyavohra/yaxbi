...
const SectionOne = () => {
    return (
    <section className="sectionOne main">
        <div className="topArea">
            <p className="tip">Transform</p>
            <h3 className="title">
                Unlock Your Business Potential with Yaxbi.
            </h3>
            <h6 className="descrip">
            Discover how Yaxbi can transform your business with our comprehensive
            tech solutions. From MVP development to enterprise digital transformation, we have you covered.
            </h6>
        </div>
